class UsersController < ApplicationController
    ...
    if @user.save
			@user.posts.create!(:title => 'Your First Post', :text => '<section class="text_center_panel classic_font color_white"><p>Highlight any text to style it. Use the left to add image.</p><p>Welcome to Sailnote. Writing is hard. We\'ll try to help you.</p></section>', :url => 'first')
